...
`D:\AI\Dictionary\gui-os-design-guideline-dictionary`
...
- `public/index.html`
- `dist/gui-os-design-guideline-dictionary-docs.zip`

## セットアップ手順

```powershell
cd D:\AI\Dictionary\gui-os-design-guideline-dictionary
npm test
npm start
```
...
4. `dist/gui-os-design-guideline-dictionary-docs.zip` を展開し、README、導入手順、ユーザーガイド、QCDS、release evidence が含まれることを確認する。
